...
capture log close 
log using "$output\DALY\make_daly_loss_case_late_symp_ns_2030_2064_truncated_6pct", text replace 
...
/*
inputs:
late_symp_ns_1_99_year2022_single_ages_w_life_tables.dta created in: make_daly_loss_case_late_symp_ns_2030_2064_truncated.do
ihme_country_list_syphilis_with_geo.dta created in: make_ihme_country_list_syphilis.do
outputs:
daly_loss_case_late_symp_ns_2030_2064_truncated_6pct.dta
*/
...
save  "$output\DALY\yld_loss_case_late_symp_ns_birthyear_2022_truncated_$analysis"   , replace 
...
clear 
capture erase "$output\DALY\daly_loss_case_late_symp_ns_2030_2064_truncated_$analysis.dta"
save          "$output\DALY\daly_loss_case_late_symp_ns_2030_2064_truncated_$analysis.dta", replace emptyok
...
use if country=="`country'" using "$output\DALY\yld_loss_case_late_symp_ns_birthyear_2022_truncated_$analysis" , clear
expand 43 
...
append using "$output\DALY\daly_loss_case_late_symp_ns_2030_2064_truncated_$analysis.dta"
sort country birth_year 
compress 
save         "$output\DALY\daly_loss_case_late_symp_ns_2030_2064_truncated_$analysis.dta", replace  

end 

use "$output\DALY\yld_loss_case_late_symp_ns_birthyear_2022_truncated_$analysis" , clear 
...
use "$output\DALY\daly_loss_case_late_symp_ns_2030_2064_truncated_$analysis.dta", clear
