...
capture log close 
log using "$output\DALY\make_daly_loss_case_preterm_2030_2064_truncated_6pct", text replace 
...
outputs:
daly_loss_case_preterm_2030_2064_truncated_6pct.dta
*/
...
save  "$output\DALY\ylls_case_preterm_collapsed_6pct.dta", replace
...
clear 
capture erase "$output\DALY\ylds_case_preterm_truncated_6pct.dta"
save          "$output\DALY\ylds_case_preterm_truncated_6pct.dta" , emptyok replace 
...
append using "$output\DALY\ylds_case_preterm_truncated_6pct.dta"
sort country birth_year age 
save         "$output\DALY\ylds_case_preterm_truncated_6pct.dta" , replace 
...
use "$output\DALY\ylds_case_preterm_truncated_6pct.dta", clear 
assert age==0 
drop age 
sum yld_case, d 

merge 1:1 country birth_year using "$output\DALY\ylls_case_preterm_collapsed_6pct.dta"
assert _m==3 
drop _m 

sort country birth_year 

save "$output\DALY\ylls_&_ylds_case_preterm_truncated_6pct.dta", replace
...
clear 
capture erase "$output\DALY\daly_loss_case_preterm_2030_2064_truncated_6pct.dta"
save          "$output\DALY\daly_loss_case_preterm_2030_2064_truncated_6pct.dta", replace emptyok
...
use if country=="`country'" using "$output\DALY\ylls_&_ylds_case_preterm_truncated_6pct.dta", clear
gen expand=0 
...
append using "$output\DALY\daly_loss_case_preterm_2030_2064_truncated_6pct.dta"
sort country birth_year 
compress 
save "$output\DALY\daly_loss_case_preterm_2030_2064_truncated_6pct.dta", replace  

end 

use "$output\DALY\ylls_&_ylds_case_preterm_truncated_6pct.dta", clear 
...
use  "$output\DALY\daly_loss_case_preterm_2030_2064_truncated_6pct.dta", clear
