...
capture log close 
log using "$output\DALY\UPPER\make_daly_loss_case_early_symp_cs_2030_2064_upper", text replace 
...
/*
inputs:
early_symptomatic_cs_infectious_syndrome_incidence_prevalence_ylds_2019_2022_upper.dta created in: make_GBD_2021_congenital_syphilis_upper_lower.do
...
outputs:
daly_loss_case_early_symp_cs_2030_2064_upper.dta 
*/
...
use "$output\IHME\GBD 2021\CS\early_symptomatic_cs_infectious_syndrome_incidence_prevalence_ylds_2019_2022_upper", clear 
...
compress
save "$output\IHME\GBD 2021\CS\early_symp_cs_0_4_years_year2022_upper", replace
...
use "$output\IHME\GBD 2021\CS\early_symp_cs_0_4_years_year2022_upper", clear
...
compress
save "$output\IHME\GBD 2021\CS\early_symp_cs_0_4_years_year2022_single_ages_upper", replace
...
keep if year==2022
merge 1:1 country year age using "$output\IHME\GBD 2021\CS\early_symp_cs_0_4_years_year2022_single_ages_upper"
assert _m!=2
keep if _m==3 
drop _m 
sort country year age 
...
compress 
save "$output\DALY\UPPER\early_symp_cs_0_4_years_year2022_single_ages_w_life_tables", replace

////////////////////////////////////////////////////////////////////////////////
////////////////////////// compute expected lifetime YLDs //////////////////////
////////////////////////////////////////////////////////////////////////////////

use "$output\DALY\UPPER\early_symp_cs_0_4_years_year2022_single_ages_w_life_tables", clear
...
save  "$output\DALY\UPPER\yld_loss_case_early_symp_cs_birthyear_2022"   , replace 
...
clear 
capture erase "$output\DALY\UPPER\daly_loss_case_early_symp_cs_2030_2064.dta"
save          "$output\DALY\UPPER\daly_loss_case_early_symp_cs_2030_2064.dta", replace emptyok
...
use if country=="`country'" using "$output\DALY\UPPER\yld_loss_case_early_symp_cs_birthyear_2022" , clear
expand 43 
...
append using "$output\DALY\UPPER\daly_loss_case_early_symp_cs_2030_2064.dta"
sort country birth_year 
compress 
save         "$output\DALY\UPPER\daly_loss_case_early_symp_cs_2030_2064.dta", replace  

end 

use "$output\DALY\UPPER\yld_loss_case_early_symp_cs_birthyear_2022", clear 
...
use "$output\DALY\UPPER\daly_loss_case_early_symp_cs_2030_2064.dta", clear
