...
capture log close 
log using "$output\DALY\UPPER\make_daly_loss_case_late_symp_ns_2030_2064_truncated_upper", text replace 
...
/*
inputs:
late_symptomatic_cs_neurosyphilis_prevalence_ylds_2019_2022_upper.dta created in: make_GBD_2021_congenital_syphilis_upper_lower.do
...
outputs:
daly_loss_case_late_symp_ns_2030_2064_truncated.dta
*/
...
use "$output\IHME\GBD 2021\CS\late_symptomatic_cs_neurosyphilis_prevalence_ylds_2019_2022_upper", clear

drop if regexm(age,"neonatal")

keep if unit=="Number"
assert condition=="Late symptomatic congenital syphilis, neurosyphilis"
drop unit condition 
...
compress
save "$output\IHME\GBD 2021\CS\late_symp_ns_1_99_years_year2022_upper", replace
...
use "$output\IHME\GBD 2021\CS\late_symp_ns_1_99_years_year2022_upper", clear
...
replace yld_case=0 if age<1

order country year 
sort country year age 

compress
save "$output\IHME\GBD 2021\CS\late_symp_ns_1_99_years_year2022_single_ages_upper", replace
...
keep if year==2022
merge 1:1 country year age using "$output\IHME\GBD 2021\CS\late_symp_ns_1_99_years_year2022_single_ages_upper"
assert _m!=2
keep if _m==3 
drop _m 
sort country year age 
...
compress 
save "$output\DALY\UPPER\late_symp_ns_1_99_year2022_single_ages_w_life_tables", replace

////////////////////////////////////////////////////////////////////////////////
////////////////////////// compute expected lifetime YLDs //////////////////////
////////////////////////////////////////////////////////////////////////////////

use "$output\DALY\UPPER\late_symp_ns_1_99_year2022_single_ages_w_life_tables", clear
...
save  "$output\DALY\UPPER\yld_loss_case_late_symp_ns_birthyear_2022_truncated"   , replace 

////////////////////////////////////////////////////////////////////////////////
////// extrapolate ylds per case to 2064 using constant the 2022 values ////////
////////////////////////////////////////////////////////////////////////////////

clear 
capture erase "$output\DALY\UPPER\daly_loss_case_late_symp_ns_2030_2064_truncated.dta"
save          "$output\DALY\UPPER\daly_loss_case_late_symp_ns_2030_2064_truncated.dta", replace emptyok
...
use if country=="`country'" using "$output\DALY\UPPER\yld_loss_case_late_symp_ns_birthyear_2022_truncated" , clear
expand 43 
...
assert yld_case<. 
ren yld_case late_symp_ns_dalys

order country birth_year late_symp_ns_dalys
drop if birth_year<2030

append using "$output\DALY\UPPER\daly_loss_case_late_symp_ns_2030_2064_truncated.dta"
sort country birth_year 
compress 
save         "$output\DALY\UPPER\daly_loss_case_late_symp_ns_2030_2064_truncated.dta", replace  

end 

use "$output\DALY\UPPER\yld_loss_case_late_symp_ns_birthyear_2022_truncated" , clear 
...
use "$output\DALY\UPPER\daly_loss_case_late_symp_ns_2030_2064_truncated.dta", clear
...
foreach g of local region {
	...
	sum late_symp_ns_dalys if who_region == "`g'", d
}
