...
capture log close 
log using "$output\DALY\make_daly_loss_case_late_symp_ns_2030_2064_truncated", text replace 
...
outputs:
late_symp_ns_1_99_year2022_single_ages_w_life_tables.dta
...
compress
save "$output\IHME\GBD 2021\CS\late_symp_ns_1_99_years_year2022", replace
...
use "$output\IHME\GBD 2021\CS\late_symp_ns_1_99_years_year2022", clear
...
compress
save "$output\IHME\GBD 2021\CS\late_symp_ns_1_99_years_year2022_single_ages", replace
...
keep if year==2022
merge 1:1 country year age using "$output\IHME\GBD 2021\CS\late_symp_ns_1_99_years_year2022_single_ages"
assert _m!=2
keep if _m==3 
drop _m 
sort country year age 
...
compress 
save "$output\DALY\late_symp_ns_1_99_year2022_single_ages_w_life_tables", replace

////////////////////////////////////////////////////////////////////////////////
////////////////////////// compute expected lifetime YLDs //////////////////////
////////////////////////////////////////////////////////////////////////////////

use "$output\DALY\late_symp_ns_1_99_year2022_single_ages_w_life_tables", clear
...
save  "$output\DALY\yld_loss_case_late_symp_ns_birthyear_2022_truncated"  , replace 
...
clear 
capture erase "$output\DALY\daly_loss_case_late_symp_ns_2030_2064_truncated.dta"
save          "$output\DALY\daly_loss_case_late_symp_ns_2030_2064_truncated.dta", replace emptyok
...
use if country=="`country'" using "$output\DALY\yld_loss_case_late_symp_ns_birthyear_2022_truncated" , clear
expand 43 
...
append using "$output\DALY\daly_loss_case_late_symp_ns_2030_2064_truncated.dta"
sort country birth_year 
compress 
save         "$output\DALY\daly_loss_case_late_symp_ns_2030_2064_truncated.dta", replace  

end 

use "$output\DALY\yld_loss_case_late_symp_ns_birthyear_2022_truncated" , clear 
