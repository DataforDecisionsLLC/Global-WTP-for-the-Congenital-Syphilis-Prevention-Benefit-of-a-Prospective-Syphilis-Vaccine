...
capture log close 
log using "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\make_tree_results_vax_6pct_health_6pct_costs", text replace

/*
inputs:
analytical_data_ihme_countries_age15_cohort_6pct_health_6pct_cost.dta created in: make_analytical_data_ihme_countries_age15_cohort_6pct_health_6pct_cost.do
outputs:
tree_results_vax_6pct_health_6pct_cost.dta
*/

clear
capture erase "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_vax_6pct_health_6pct_costs.dta"
save          "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_vax_6pct_health_6pct_costs", replace emptyok
...
append using "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_vax_6pct_health_6pct_costs.dta"
sort country age 
compress
save         "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_vax_6pct_health_6pct_costs.dta", replace 
