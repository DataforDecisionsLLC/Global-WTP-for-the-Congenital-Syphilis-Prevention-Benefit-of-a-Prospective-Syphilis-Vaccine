...
capture log close 
log using "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\make_tree_results_novax_0pct_health_3pct_costs", text replace

/*
inputs:
analytical_data_ihme_countries_age15_cohort_0pct_health_3pct_costs.dta created in: make_analytical_data_ihme_countries_age15_cohort_0pct_health_3pct_costs.do
outputs:
tree_results_novax_0pct_health_3pct_cost.dta
*/

clear
capture erase "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_novax_0pct_health_3pct_costs.dta"
save          "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_novax_0pct_health_3pct_costs", replace emptyok
...
append using "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_novax_0pct_health_3pct_costs.dta"
sort country age 
compress
save         "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_novax_0pct_health_3pct_costs.dta", replace 
