...
capture log close 
log using "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\make_tree_results_novax_indirect_costs_minus_20_pct", text replace

/*
inputs:
analytical_data_ihme_countries_age15_cohort_indirect_costs_minus_20_pct.dta created in: make_analytical_data_ihme_countries_age15_cohort_indirect_costs_minus_20_pct.do
outputs:
tree_results_novax_indirect_costs_minus_20_pct.dta
*/

clear
capture erase "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_novax_indirect_costs_minus_20_pct.dta"
save          "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_novax_indirect_costs_minus_20_pct", replace emptyok
...
use "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\analytical_data_ihme_countries_age15_cohort_indirect_costs_minus_20_pct", clear 
...
append using "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_novax_indirect_costs_minus_20_pct.dta"
sort country age 
compress
save         "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_novax_indirect_costs_minus_20_pct.dta", replace 
