...
capture log close 
log using "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\make_tree_results_novax_ve80_wane10", text replace

/*
inputs:
analytical_data_ihme_countries_age15_cohort_ve80_wane10.dta created in: make_analytical_data_ihme_countries_age15_cohort_ve80_wane10.do
outputs:
tree_results_novax_ve80_wane10.dta
*/

clear
capture erase "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_novax_ve80_wane10.dta"
save          "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_novax_ve80_wane10", replace emptyok
...
use "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\analytical_data_ihme_countries_age15_cohort_ve80_wane10", clear 
...
append using "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_novax_ve80_wane10.dta"
sort country age 
compress
save         "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_novax_ve80_wane10.dta", replace 
