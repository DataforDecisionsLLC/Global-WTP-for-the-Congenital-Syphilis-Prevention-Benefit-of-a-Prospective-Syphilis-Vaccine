...
capture log close 
log using "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\make_tree_results_novax_ve50_wane5", text replace

/*
inputs:
analytical_data_ihme_countries_age15_cohort_ve50_wane5.dta created in: make_analytical_data_ihme_countries_age15_cohort_ve50_wane5.do
outputs:
tree_results_novax_ve50_wane5.dta
*/

clear
capture erase "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_novax_ve50_wane5.dta"
save          "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_novax_ve50_wane5", replace emptyok
...
append using "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_novax_ve50_wane5.dta"
sort country age 
compress
save         "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_novax_ve50_wane5.dta", replace 
