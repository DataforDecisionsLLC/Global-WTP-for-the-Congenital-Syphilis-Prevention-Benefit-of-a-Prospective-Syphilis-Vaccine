...
capture log close 
log using "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\make_tree_results_vax_0pct_health_0pct_costs", text replace

/*
inputs:
analytical_data_ihme_countries_age15_cohort_0pct_health_0pct_cost.dta created in: make_analytical_data_ihme_countries_age15_cohort_0pct_health_0pct_cost.do
outputs:
tree_results_vax_0pct_health_0pct_cost.dta
*/

clear
capture erase "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_vax_0pct_health_0pct_costs.dta"
save          "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_vax_0pct_health_0pct_costs", replace emptyok
...
scalar prob_inf = prob_syph_vax  
scalar prob_noinf = prob_no_syph_vax  
...
append using "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_vax_0pct_health_0pct_costs.dta"
sort country age 
compress
save         "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_vax_0pct_health_0pct_costs.dta", replace 
