...
capture log close 
log using "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\make_tree_results_novax_age25_cohort", text replace

/*
inputs:
analytical_data_ihme_countries_age25_cohort.dta created in: make_analytical_data_ihme_countries_age25_cohort.do
outputs:
tree_results_novax_age25_cohort.dta
*/

clear
capture erase "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_novax_age25_cohort.dta"
save          "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_novax_age25_cohort", replace emptyok
...
append using "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_novax_age25_cohort.dta"
sort country age 
compress
save         "$output\DECISION TREE\TREE RESULTS\SENSITIVITY ANALYSIS\tree_results_novax_age25_cohort.dta", replace 
