...
capture log close 
log using "$output\DECISION TREE\TREE RESULTS\make_tree_results_vax_truncated", text replace
...
outputs:
tree_results_vax_truncated.dta
*/

clear
capture erase "$output\DECISION TREE\TREE RESULTS\tree_results_vax_truncated.dta"
save          "$output\DECISION TREE\TREE RESULTS\tree_results_vax_truncated", replace emptyok
...
append using "$output\DECISION TREE\TREE RESULTS\tree_results_vax_truncated"
sort country age 
compress
save         "$output\DECISION TREE\TREE RESULTS\tree_results_vax_truncated", replace 
