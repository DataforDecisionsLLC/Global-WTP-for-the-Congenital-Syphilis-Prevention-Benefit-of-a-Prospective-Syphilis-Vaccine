...
capture log close 
log using "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\make_analytical_data_ihme_countries_age15_cohort_0pct_health_3pct_costs", text replace 
...
outputs:
analytical_data_ihme_countries_age15_cohort_0pct_health_3pct_costs.dta
*/
...
save "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\analytical_data_ihme_countries_age15_cohort_0pct_health_3pct_costs", replace
...
merge 1:m country year using "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\analytical_data_ihme_countries_age15_cohort_0pct_health_3pct_costs"
assert _m!=1 
...
use  "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\analytical_data_ihme_countries_age15_cohort_0pct_health_3pct_costs", clear
...
merge 1:1 country year using "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\analytical_data_ihme_countries_age15_cohort_0pct_health_3pct_costs"
assert _m!=2
