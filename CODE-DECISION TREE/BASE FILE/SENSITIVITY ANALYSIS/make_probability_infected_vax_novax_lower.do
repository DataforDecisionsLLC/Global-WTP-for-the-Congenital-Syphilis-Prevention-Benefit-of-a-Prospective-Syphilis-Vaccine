...
capture log close 
log using "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\LOWER\make_probability_infected_vax_novax_lower", text replace

/*
inputs:
GBD_2021_syphilis_incidence_rates_reference_scenario_lower.dta created in: make_GBD_2021_syphilis_incidence_rates_upper_lower.do
outputs:
...
use "$output\IHME\GBD 2021\SYPHILIS\GBD_2021_syphilis_incidence_rates_reference_scenario_lower", clear
split age, parse("to")
...
compress 
save "$output\IHME\GBD 2021\SYPHILIS\GBD_2021_syphilis_incidence_rates_single_age_lower", replace

////////////////////////////////////////////////////////////////////////////////
////// keep the age-year pairs for the cohort aged 15 cohort in year 2030 //////
////////////////////////////////////////////////////////////////////////////////

use "$output\IHME\GBD 2021\SYPHILIS\GBD_2021_syphilis_incidence_rates_single_age_lower", clear
...
compress 
save "$output\IHME\GBD 2021\SYPHILIS\GBD_2021_syphilis_incidence_rates_age15_cohort_lower", replace

////////////////////////////////////////////////////////////////////////////////
////// compute incidence rates and probability of infection under no vax ///////
////////////////////////////////////////////////////////////////////////////////

use  "$output\IHME\GBD 2021\SYPHILIS\GBD_2021_syphilis_incidence_rates_age15_cohort_lower", clear
...
compress 
save "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\LOWER\probability_infected_novax", replace
...
merge 1:1 country age year using "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\LOWER\probability_infected_novax"
assert _m==3 
drop _m pooled_inc
...
compress 
save "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\LOWER\probability_infected_vax_novax", replace
