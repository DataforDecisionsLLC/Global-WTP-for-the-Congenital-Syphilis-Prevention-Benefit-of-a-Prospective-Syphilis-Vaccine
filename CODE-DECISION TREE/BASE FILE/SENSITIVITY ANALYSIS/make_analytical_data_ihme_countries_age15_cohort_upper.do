...
capture log close 
log using "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\make_analytical_data_ihme_countries_age15_cohort_upper", text replace 
...
probability_infected_vax_novax.dta created in: make_probability_infected_vax_novax_upper.do
daly_loss_case_preterm_2030_2064_truncated.dta created in: make_daly_loss_case_preterm_2030_2064_truncated_upper.do
daly_loss_case_early_symp_cs_2030_2064.dta created in: make_daly_loss_case_early_symp_cs_2030_2064_upper.do
daly_loss_case_late_symp_ns_2030_2064_truncated.dta created in: make_daly_loss_case_late_symp_ns_2030_2064_truncated_upper.do
daly_loss_case_late_symp_hl_2030_2064_truncated.dta created in: make_daly_loss_case_late_symp_hl_2030_2064_truncated_upper.do
outputs:
...
save "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\analytical_data_ihme_countries_age15_cohort_truncated_upper", replace

////////////////////////////////////////////////////////////////////////////////
//////////////// map on the probability of infected with syphilis //////////////
////////////////////////////////////////////////////////////////////////////////

use  "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\analytical_data_ihme_countries_age15_cohort_truncated_upper", clear 

merge 1:1 country age year using "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\UPPER\probability_infected_vax_novax"
assert _m!=1 
...
merge 1:1 country year using "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\analytical_data_ihme_countries_age15_cohort_truncated_upper"
assert _m!=2
