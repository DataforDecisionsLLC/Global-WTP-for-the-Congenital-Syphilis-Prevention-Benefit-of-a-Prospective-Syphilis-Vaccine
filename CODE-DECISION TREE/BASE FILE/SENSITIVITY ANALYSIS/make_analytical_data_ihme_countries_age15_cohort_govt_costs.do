...
capture log close 
log using "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\make_analytical_data_ihme_countries_age15_cohort_govt_costs", text replace 
...
acute_costs_series_bia.dta created in: make_acute_costs_series_bia.do 
post_acute_costs_series_truncated_government.dta created in: make_post_acute_costs_series_truncated_government.do
...
outputs:
analytical_data_ihme_countries_age15_cohort_govt_costs.dta
*/

use  "$output\DECISION TREE\BASE FILE\analytical_data_ihme_countries_age15_cohort_truncated", clear 
drop cost_*
save "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\analytical_data_ihme_countries_age15_cohort_govt_costs", replace

////////////////////////////////////////////////////////////////////////////////
// map on costs: acute direct, post acute direct, and indirect for ns and hl ///
////////////////////////////////////////////////////////////////////////////////

use "$output\ECONOMIC DATA\DIRECT COSTS\acute_costs_series_bia", clear 
drop if year<2030
merge 1:1 country year using "$output\ECONOMIC DATA\DIRECT COSTS\post_acute_costs_series_truncated_government"
assert _m==3 
drop _m 
sort country year
...
gen cost_neurosyph_15_19 = acute_cost_nonABO_15_19 + lifetime_cost_neurosyph 
gen cost_neurosyph_20_49 = acute_cost_nonABO_20_49 + lifetime_cost_neurosyph 

gen cost_hearingloss_15_19 = acute_cost_nonABO_15_19 + lifetime_cost_hearinglos 
gen cost_hearingloss_20_49 = acute_cost_nonABO_20_49 + lifetime_cost_hearinglos 

drop acute* lifetime* indirect_*

merge 1:m country year using "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\analytical_data_ihme_countries_age15_cohort_govt_costs"
assert _m!=1 
