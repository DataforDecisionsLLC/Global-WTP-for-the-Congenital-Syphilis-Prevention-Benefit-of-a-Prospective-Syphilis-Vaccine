...
capture log close 
log using "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\make_analytical_data_ihme_countries_age15_cohort_who_emtct", text replace 
...
coverage_data_series_who_emtct.dta created in: make_coverage_data_series_who_emtct.do  
outputs:
analytical_data_ihme_countries_age15_cohort_who_emtct.dta
*/

use "$output\DECISION TREE\BASE FILE\analytical_data_ihme_countries_age15_cohort_truncated", clear 

drop prob_anc prob_no_anc prob_testing prob_no_testing prob_treatment prob_no_treatment

save "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\analytical_data_ihme_countries_age15_cohort_who_emtct", replace
...
merge 1:1 country year using "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\coverage_data_series_who_emtct"
