...
capture log close 
log using "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\make_analytical_data_ihme_countries_age15_cohort_fertility_high", text replace 
...
probability_pregnant_sensitivity_analysis.dta created in: make_probability_pregnant_sensitivity_analysis.do 
outputs:
analytical_data_ihme_countries_age15_cohort_fertility_high.dta
*/

use "$output\DECISION TREE\BASE FILE\analytical_data_ihme_countries_age15_cohort_truncated", clear 

drop prob_preg prob_no_preg

save "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\analytical_data_ihme_countries_age15_cohort_fertility_high", replace
...
merge 1:1 country age year using "$output\FERTILITY\SENSITIVITY ANALYSIS\probability_pregnant_sensitivity_analysis", keepusing(country age year prob_preg_high)
assert _m!=1 
keep if _m==3 
drop _m 

ren prob_preg_high prob_preg
...
////////////////////////////////////////////////////////////////////////////////
////////////////// compute the probability of no pregnancy /////////////////////
////////////////////////////////////////////////////////////////////////////////
