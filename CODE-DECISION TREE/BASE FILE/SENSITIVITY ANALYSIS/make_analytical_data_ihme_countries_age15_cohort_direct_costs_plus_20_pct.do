...
capture log close 
log using "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\make_analytical_data_ihme_countries_age15_cohort_direct_costs_plus_20_pct", text replace 
...
outputs:
analytical_data_ihme_countries_age15_cohort_direct_costs_plus_20_pct.dta
*/
...
save "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\analytical_data_ihme_countries_age15_cohort_direct_costs_plus_20_pct", replace

////////////////////////////////////////////////////////////////////////////////
// map on costs: acute direct, post acute direct, and indirect for ns and hl ///
/////////////////////// increase direct costs by 20% ///////////////////////////
////////////////////////////////////////////////////////////////////////////////
...
merge 1:m country year using "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\analytical_data_ihme_countries_age15_cohort_direct_costs_plus_20_pct"
assert _m!=1 
