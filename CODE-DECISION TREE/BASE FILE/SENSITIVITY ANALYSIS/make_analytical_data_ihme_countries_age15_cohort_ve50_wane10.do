...
capture log close 
log using "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\make_analytical_data_ihme_countries_age15_cohort_ve50_wane10", text replace 
...
probability_infected_vax_novax_ve50_wane10.dta created in: make_probability_infected_vax_novax_ve50_wane10.do
outputs:
analytical_data_ihme_countries_age15_cohort_ve50_wane10.dta
*/
...
save "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\analytical_data_ihme_countries_age15_cohort_ve50_wane10", replace
...
merge 1:1 country age year using "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\probability_infected_vax_novax_ve50_wane10" 
assert _m!=1 
