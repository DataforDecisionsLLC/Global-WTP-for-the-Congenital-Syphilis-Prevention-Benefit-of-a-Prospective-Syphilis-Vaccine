...
capture log close 
log using "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\make_probability_infected_vax_novax_ve50_wane10", text replace
...
outputs:
probability_infected_vax_novax_ve50_wane10.dta
*/
...
compress 
save "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\probability_infected_vax_novax_ve50_wane10", replace
