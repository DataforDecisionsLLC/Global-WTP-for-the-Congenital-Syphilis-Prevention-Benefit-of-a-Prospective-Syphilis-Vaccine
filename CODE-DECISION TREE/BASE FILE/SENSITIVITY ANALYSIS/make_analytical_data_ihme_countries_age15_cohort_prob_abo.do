...
capture log close 
log using "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\make_analytical_data_ihme_countries_age15_cohort_prob_abo", text replace 
...
probability_abo_sensitivity_analysis.dta created in: make_probability_abo_sensitivity_analysis.do 
outputs:
analytical_data_ihme_countries_age15_cohort_prob_abo.dta
*/
...
prob_trtd_hearloss ///
prob_untr_hearloss ///
prob_uninf_lbw_preterm ///
prob_trtd_lbw_preterm ///
prob_untr_lbw_preterm ///
prob_uninf_neonatal_death ///
prob_trtd_neonatal_death ///
prob_untr_neonatal_death ///
prob_trtd_neurosyph ///
prob_untr_neurosyph ///
prob_uninf_normal ///
prob_trtd_normal ///
prob_untr_normal ///
prob_uninf_stillbirth ///
prob_trtd_stillbirth ///
prob_untr_stillbirth

save "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\analytical_data_ihme_countries_age15_cohort_prob_abo", replace
...
use "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\probability_abo_sensitivity_analysis", clear
assert analysis == "sensitivity"
drop analysis 

append using  "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\analytical_data_ihme_countries_age15_cohort_prob_abo"
