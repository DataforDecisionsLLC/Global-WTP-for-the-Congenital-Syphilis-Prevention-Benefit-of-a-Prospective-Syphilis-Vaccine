...
capture log close 
log using "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\make_analytical_data_ihme_countries_age15_cohort_6pct_health_6pct_costs", text replace 
...
post_acute_costs_series_truncated_6pct.dta created in: make_post_acute_costs_series_truncated_6pct.do
indirect_costs_cerebral_palsy.dta created in: make_indirect_costs_cerebral_palsy.do 
lifetime_expected_productivity_costs_hearing_loss_truncated_6pct.dta created in: make_lifetime_expected_indirect_costs_hearing_loss_truncated_6pct.do 
dalys_sb_nd_discounted_6pct.dta created in: make_dalys_sb_nd_discounted_6pct.do
daly_loss_case_preterm_2030_2064_truncated_6pct.dta created in: make_daly_loss_case_preterm_2030_2064_truncated_6pct.do
daly_loss_case_early_symp_cs_2030_2064_6pct.dta created in: make_daly_loss_case_early_symp_cs_2030_2064_6pct.do
daly_loss_case_late_symp_ns_2030_2064_truncated_6pct.dta created in: make_daly_loss_case_late_symp_hl_2030_2064_truncated_6pct.do
daly_loss_case_late_symp_hl_2030_2064_truncated_6pct.dta created in: make_daly_loss_case_late_symp_ns_2030_2064_truncated_6pct.do
outputs:
analytical_data_ihme_countries_age15_cohort_6pct_health_6pct_costs.dta
*/

use "$output\DECISION TREE\BASE FILE\analytical_data_ihme_countries_age15_cohort_truncated", clear 
drop cost_* stillbirth_dalys neonatal_dalys early_symp_cs_dalys preterm_dalys late_symp_hl_dalys late_symp_ns_dalys
save "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\analytical_data_ihme_countries_age15_cohort_6pct_health_6pct_costs", replace
...
drop if year<2030
merge 1:1 country year using "$output\ECONOMIC DATA\DIRECT COSTS\post_acute_costs_series_truncated_6pct"
assert _m==3 
drop _m 
sort country year
...
merge 1:1 country year using "$output\ECONOMIC DATA\INDIRECT COSTS\lifetime_expected_productivity_costs_hearing_loss_truncated_6pct" , ///
...
merge 1:m country year using "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\analytical_data_ihme_countries_age15_cohort_6pct_health_6pct_costs"
assert _m!=1 
...
use  "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\analytical_data_ihme_countries_age15_cohort_6pct_health_6pct_costs", clear
merge m:1 country year using "$output\DALY\dalys_sb_nd_discounted_6pct"
assert _m!=1 
assert inlist(country,"Cuba","Monaco","North Korea","Syria","Venezuela") if _m==2
keep if _m==3 
drop _m 
...
use "$output\DALY\daly_loss_case_preterm_2030_2064_truncated_6pct", clear 
ren birth_year year 
keep country year preterm_dalys

merge 1:1 country year using "$output\DECISION TREE\BASE FILE\SENSITIVITY ANALYSIS\analytical_data_ihme_countries_age15_cohort_6pct_health_6pct_costs"
assert _m!=2
...
use "$output\DALY\daly_loss_case_early_symp_cs_2030_2064_6pct.dta", clear
ren birth_year year 
...
use "$output\DALY\daly_loss_case_late_symp_ns_2030_2064_truncated_6pct.dta", clear 
ren birth_year year 
...
use "$output\DALY\daly_loss_case_late_symp_hl_2030_2064_truncated_6pct.dta", clear 
ren birth_year year 
