...
capture log close 
log using "$output\DECISION TREE\BASE FILE\make_probability_infected_vax_novax", text replace

/*
inputs:
GBD_2021_syphilis_incidence_rates_reference_scenario.dta created in: make_GBD_2021_syphilis_incidence_rates.do 
outputs:
GBD_2021_syphilis_incidence_rates_single_age.dta
GBD_2021_syphilis_incidence_rates_age15_cohort.dta 
probability_infected_novax.dta
...
use "$output\IHME\GBD 2021\SYPHILIS\GBD_2021_syphilis_incidence_rates_reference_scenario", clear
split age, parse("to")
...
compress 
save "$output\IHME\GBD 2021\SYPHILIS\GBD_2021_syphilis_incidence_rates_single_age", replace
...
compress 
save "$output\IHME\GBD 2021\SYPHILIS\GBD_2021_syphilis_incidence_rates_age15_cohort", replace
...
compress 
save "$output\DECISION TREE\BASE FILE\probability_infected_novax", replace
...
compress 
save "$output\DECISION TREE\BASE FILE\probability_infected_vax_novax", replace
