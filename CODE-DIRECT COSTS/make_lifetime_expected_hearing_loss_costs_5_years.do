...
capture log close
log using "$output\ECONOMIC DATA\DIRECT COSTS\make_lifetime_expected_hearing_loss_costs_5_years", text replace
...
outputs:
lifetime_expected_hearing_loss_costs_5_years.dta
*/
...
clear 
capture erase "$output\ECONOMIC DATA\DIRECT COSTS\lifetime_expected_hearing_loss_costs_5_years" 
save          "$output\ECONOMIC DATA\DIRECT COSTS\lifetime_expected_hearing_loss_costs_5_years" , emptyok replace 
...
sort country year age 
save         "$output\ECONOMIC DATA\DIRECT COSTS\lifetime_expected_hearing_loss_costs_5_years"  , replace 
...
use "$output\ECONOMIC DATA\DIRECT COSTS\lifetime_expected_hearing_loss_costs_5_years" , clear 
assert age==0 
drop age 
