...
capture log close
log using "$output\ECONOMIC DATA\DIRECT COSTS\make_lifetime_expected_hearing_loss_costs_truncated_0pct", text replace
...
outputs:
lifetime_expected_hearing_loss_costs_truncated_0pct.dta
*/
...
clear 
capture erase "$output\ECONOMIC DATA\DIRECT COSTS\lifetime_expected_hearing_loss_costs_truncated_0pct" 
save          "$output\ECONOMIC DATA\DIRECT COSTS\lifetime_expected_hearing_loss_costs_truncated_0pct" , emptyok replace 
...
sort country year age 
save         "$output\ECONOMIC DATA\DIRECT COSTS\lifetime_expected_hearing_loss_costs_truncated_0pct"  , replace 
...
use "$output\ECONOMIC DATA\DIRECT COSTS\lifetime_expected_hearing_loss_costs_truncated_0pct" , clear 
assert age==0 
drop age 
