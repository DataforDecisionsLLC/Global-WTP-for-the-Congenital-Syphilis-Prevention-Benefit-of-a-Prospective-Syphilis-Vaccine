...
capture log close
log using "$output\ECONOMIC DATA\DIRECT COSTS\make_post_acute_costs_series_truncated_6pct", text replace

/*
inputs:
general_population_lifetime_medical_costs_truncated_6pct.dta created in: make_general_population_lifetime_medical_costs_truncated_6pct.do 
lifetime_expected_preterm_costs_truncated.dta created in: make_post_acute_costs_series_truncated.do 
lifetime_expected_hearing_loss_costs_truncated_6pct.dta created in: make_lifetime_expected_hearing_loss_costs_truncated_6pct.do
outputs:
post_acute_costs_series_truncated_6pct.dta
*/
...
use "$output\ECONOMIC DATA\DIRECT COSTS\general_population_lifetime_medical_costs_truncated_6pct", clear 
...
save "$output\ECONOMIC DATA\DIRECT COSTS\lifetime_expected_neurosyphilis_costs_truncated_6pct" , replace 
...
append using "$output\ECONOMIC DATA\DIRECT COSTS\lifetime_expected_neurosyphilis_costs_truncated_6pct" 
append using "$output\ECONOMIC DATA\DIRECT COSTS\lifetime_expected_hearing_loss_costs_truncated_6pct" 
append using "$output\ECONOMIC DATA\DIRECT COSTS\general_population_lifetime_medical_costs_truncated_6pct" 
...
save "$output\ECONOMIC DATA\DIRECT COSTS\post_acute_costs_series_truncated_6pct", replace
