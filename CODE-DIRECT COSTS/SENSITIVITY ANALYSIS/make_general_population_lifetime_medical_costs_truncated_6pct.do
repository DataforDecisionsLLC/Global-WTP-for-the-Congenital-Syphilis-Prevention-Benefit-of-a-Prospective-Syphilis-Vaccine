...
capture log close
log using "$output\ECONOMIC DATA\DIRECT COSTS\make_general_population_lifetime_medical_costs_truncated_6pct", text replace
...
outputs:
general_population_lifetime_medical_costs_truncated_6pct.dta
*/
...
clear 
capture erase "$output\ECONOMIC DATA\DIRECT COSTS\general_population_lifetime_medical_costs_truncated_6pct" 
save          "$output\ECONOMIC DATA\DIRECT COSTS\general_population_lifetime_medical_costs_truncated_6pct" , emptyok replace 
...
sort country year age 
save         "$output\ECONOMIC DATA\DIRECT COSTS\general_population_lifetime_medical_costs_truncated_6pct"   , replace 
